...
ASG_32 R3 1024
ASG_32 R2 10
VEC_NEG_F32 R3 R2 R3    ; Vector negation
ASG_32 R2 10.0
ASG_32 R1 0.0
loop_print: LOAD_32 R3 R4        ; Load from memory
    ...
    ASG_32 R4 1
    ADD_F32 R1 R4 R1             ; Increment Loop
    ASG_32 R7 1
    IS_EQ R1 R2 R6               ; Compare
    ADD_I32 R6 R7 R6
